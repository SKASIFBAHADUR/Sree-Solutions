...
export const LaserFlow = ({
  ...
  useEffect(() => {
    ...
    // Pre-compile shader programs immediately to avoid GPU compile stutter
    ...
    const setSizeNow = () => {
      const w = mount.clientWidth || mount.parentElement?.clientWidth || (typeof window !== 'undefined' ? window.innerWidth : 1) || 1;
      const h = mount.clientHeight || mount.parentElement?.clientHeight || (typeof window !== 'undefined' ? window.innerHeight : 1) || 1;
    ...
    const io = new IntersectionObserver(
      entries => {
        ...
        const isNearTop = typeof window !== 'undefined' && window.scrollY < (window.innerHeight * 2);
        inViewRef.current = isIntersecting || isNearTop;
      },
    ...
    const animate = () => {
      ...
      // Force immediate visibility to eliminate any startup delays
